...
$(function() {
  ...
  function nhViewModel() {
    ...
    self.icons = ko.computed(function() {
      // dynamically populate btn-group on the left.
      var iconSet = new Set();
      var iconDict = [];
    ...
    self.rateImg = function(rating) {
      // Chains together the rating stars based on place rating.
    ...
    self.displayedPlaces = function() {
      // filters the markers and places based on keyword.
      var places = [],
  ...
  $('.infolist').each(function() {
    /**
     * JQuery magic to overcome complex css dependance issues. NOTE: http://i.imgur.com/9qzBYbH.jpg
     */
